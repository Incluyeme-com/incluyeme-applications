...
#main-content .container:before {
    ...
    <div id='vueApp' name='vueApp' class='container'>
	<div v-if='step===1' class='container'>
		...
		<div class='row'>
			<div class='col-12  mt-3'>
				...
				<button @click.prevent ='changeScreens(2)' type='submit' class='btn btn-primary' style='float: right;'>Buscar</button>
			</div>
			<div class='col-12  mt-3'>
				<div class='form-group'>
					<label class='font-weight-bold' for='names'>Búsqueda por nombre y apellido</label>
					<input type='text' class='form-control' id='names' aria-describedby='names' placeholder='Juan Perez'
					       required>
				</div>
				<button @click.prevent ='changeScreens(2)' type='submit' class='btn btn-primary' style='float: right;'>Buscar</button>
			</div>
	...
	<div v-if='step===2' class='container'>
		...
		<div class='row' style='float: right'>
			<div class='col-md-6 mt-3'>
				<div class='row'>
					<div class='col-12 mt-3'>
						<label class='font-weight-bold' for='email'>Candidato 1</label>
					</div>
					<div class='col-12 mt-3'>
						<input type='checkbox'>Juana Perez
					</div>
					<div class='col-12 mt-3'>
						<small>h@h.com</small>
					</div>
				</div>
				<input type='checkbox'>Archivo con CV encontrado
			</div>
			<div class='col-md-6 mt-3'>
				<div class='row'>
					<div class='col-12 mt-3'>
						<button type='submit' class='btn btn-success'>Ver CV cargado</button>
					</div>
					<div class='col-12 mt-3'>
						<input type='checkbox'>TE aplicante encontrado
					</div>
				</div>
			</div>
			<hr class='w-100'>
	...
	<div v-if='step===3' class='container'>
		...
		<div class='row'>
			<div class='col-12  mt-3'>
				...
				<button @click.prevent ='changeScreens(4)' type='submit' class='btn btn-primary' style='float: right;'>Buscar</button>
			</div>
			<div class='col-12  mt-3'>
				<div class='form-group'>
		...
		<div class='mt-4 row'>
			<div class='col-md-12 text-right'>
				...
				<button @click.prevent ='changeScreens(4)' type='submit' class='btn btn-success'>Mostar todos los empleos</button>
			</div>
		</div>
	</div>
